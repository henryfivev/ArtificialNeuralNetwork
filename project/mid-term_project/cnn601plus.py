...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.Sequential(
            nn.Conv2d(256, 2048, 3, 1, 1), nn.ReLU(), nn.MaxPool2d(2),nn.BatchNorm2d(2048)
        )
        self.conv4 = nn.Sequential(
            nn.Conv2d(2048, 16384, 3, 1, 1), nn.ReLU(), nn.MaxPool2d(2),nn.BatchNorm2d(16384)
        )
