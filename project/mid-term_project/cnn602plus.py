...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(3, 2048, 3, 1, 1,), nn.ReLU(), nn.MaxPool2d(2),nn.BatchNorm2d(2048)
        )
        self.conv2 = nn.Sequential(
            nn.Conv2d(2048, 32768, 3, 1, 1), nn.ReLU(), nn.MaxPool2d(2),nn.BatchNorm2d(32768)
        )
        self.fc1 = nn.Linear(32768*3*3, 2048)
...
for epoch in range(10):  # 多次循环数据集
    ...
    for i, data in enumerate(train_loader, 0):
        ...
        if i % 10 == 9:
            ...
            running_loss = 0.0
    scheduler.step()
    print(net.optimizer.state_dict()["param_groups"]["lr"])
